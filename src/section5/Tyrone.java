...
Tyrone() throws Exception {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("waaario.wav"));
	...
	public static void main(String[] args) throws Exception {
		SwingUtilities.invokeLater(new Tyrone());
	}
